...
# plot the frequency response of the filtered data using the scipy.signal.freqz() function in dB scale and in rows of subplots
...
plt.subplot(4, 1, 1)
plt.plot(sig.freqz(Input_1kHz_15kHz)[0], 20 * np.log10(abs(sig.freqz(Input_1kHz_15kHz)[1])), color="C0", label='Original data')
plt.ylabel('Amplitude [dB]')
plt.xlabel('Frequency [rad/sample]')
plt.legend()
plt.subplot(4, 1, 2)
plt.plot(sig.freqz(bartlett_filtered_data)[0], 20 * np.log10(abs(sig.freqz(bartlett_filtered_data)[1])), color="C1", label='Bartlett filtered data')
plt.ylabel('Amplitude [dB]')
plt.xlabel('Frequency [rad/sample]')
plt.legend()
plt.subplot(4, 1, 3)
plt.plot(sig.freqz(hamming_filtered_data)[0], 20 * np.log10(abs(sig.freqz(hamming_filtered_data)[1])), color="C2", label='Hamming filtered data')
plt.ylabel('Amplitude [dB]')
plt.xlabel('Frequency [rad/sample]')
plt.legend()
plt.subplot(4, 1, 4)
plt.plot(sig.freqz(blackman_filtered_data)[0], 20 * np.log10(abs(sig.freqz(blackman_filtered_data)[1])), color="C3", label='Blackman filtered data')
plt.ylabel('Amplitude [dB]')
plt.xlabel('Frequency [rad/sample]')
plt.tight_layout()
plt.legend()
...
# # plot the frequency response of the filtered data using the scipy.signal.freqz() function in dB scale in one figure
# plt.figure("Fig.6: Stacked Filtered data vs Original data in Frequency Domain", figsize=(10, 10))
# plt.suptitle('Fig.6: Stacked Filtered data vs Original data in Frequency Domain')
# plt.plot(sig.freqz(Input_1kHz_15kHz)[0], 20 * np.log10(abs(sig.freqz(Input_1kHz_15kHz)[1])), color="C0", label='Original data')
# plt.plot(sig.freqz(bartlett_filtered_data)[0], 20 * np.log10(abs(sig.freqz(bartlett_filtered_data)[1])), color="C1", label='Bartlett filtered data')
# plt.plot(sig.freqz(hamming_filtered_data)[0], 20 * np.log10(abs(sig.freqz(hamming_filtered_data)[1])), color="C2", label='Hamming filtered data')
# plt.plot(sig.freqz(blackman_filtered_data)[0], 20 * np.log10(abs(sig.freqz(blackman_filtered_data)[1])), color="C3", label='Blackman filtered data')
