...
!function (e, t) {
    ...
    var e,
      ...
      D = {
        ...
        needsContext: new RegExp(
          "^" + ge + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + ge +
            "*((?:-\\d)?\\d*)" + ge + "*\\)|)(?=[^-]|$)",
          "i",
        ),
      },
        ...
        if (11 !== p && (u = L.exec(t))) {
          if (i = u[1]) {
            if (9 === p) {
              ...
              f && (a = f.getElementById(i)) && I.contains(e, a) && a.id === i
            ) return k.call(n, a), n;
          } else {
        ...
        while ((i = a[t++]) && !u.isPropagationStopped()) {
          ...
          while ((o = i.handlers[n++]) && !u.isImmediatePropagationStopped()) {
            u.rnamespace && !1 !== o.namespace &&
                !u.rnamespace.test(o.namespace) || (u.handleObj = o,
                u.data = o.data,
                void 0 !==
                  (r =
  ...
  ce.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        !(le.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType ||
          ce.isXMLDoc(e))
      ) {
      ...
      ce.extend(le, {
        ...
        reliableTrDimensions: function () {
          ...
          return null == a && (e = C.createElement("table"),
            ...
            a =
              parseInt(r.height, 10) + parseInt(r.borderTopWidth, 10) +
                  parseInt(r.borderBottomWidth, 10) === t.offsetHeight,
            J.removeChild(e)),
            a;
        },
      }));
  ...
  ce.Animation = ce.extend(yt, {
          ...
          r
            in f && 1 === e.nodeType &&
              (n.overflow = [h.overflow, h.overflowX, h.overflowY],
                ...
                "none" === ce.css(e, "float") && (u || (p.done(function () {
                  h.display = l;
                }),
    ...
    ce.speed = function (e, t, n) {
      ...
      return ce.fx.off
        ? r.duration = 0
        : "number" != typeof r.duration && (r.duration in ce.fx.speeds
  ...
  Ut.href = Et.href,
    ce.extend({
      ...
      ajax: function (e, t) {
        ...
        for (
          i
            in (g = ce.event && v.global) && 0 == ce.active++ &&
  ...
  ce.ajaxSetup({
    ...
    ce.fn.load = function (e, t, n) {
      ...
      return -1 < s && (r = Tt(e.slice(s)), e = e.slice(0, s)),
        ...
        0 < a.length &&
        ce.ajax({ url: e, type: i || "GET", dataType: "html", data: t }).done(
          function (e) {
            o = arguments,
