package lect.lect01.cmr.implimentation;
import utils.*;
...
public class Customer {
    ...
    @DomainConstraint(mutable = false, optional = false, min = MIN_ID)
    private int id;

    @DomainConstraint(mutable = false, optional = false, length = LEN_NAME)
    private String name;
...
//    constructor
    ...
    public Customer(
        ...
        if (validateID(i))
            ...
            throw new NotPossibleException("Invalid ID: "+i);
    }
//    mutator
