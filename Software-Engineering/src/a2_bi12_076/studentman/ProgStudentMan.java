...
import a2_bi12_076.kengine.DocCnt;
import a2_bi12_076.kengine.Engine;
import a2_bi12_076.kengine.Query;
...
public class ProgStudentMan {
  ...
  public Student createStudent(Object[] data) throws NotPossibleException{
    return new Student((Integer) data[0], data[1].toString(), data[2].toString(), data[3].toString());
  }
  ...
  public UndergradStudent createUndergradStudent(Object[] data) throws NotPossibleException {
    return new UndergradStudent((Integer) data[0], data[1].toString(), data[2].toString(), data[3].toString());
  }
  ...
  public PostgradStudent createPostgradStudent(Object[] data) throws NotPossibleException{
    return new PostgradStudent((Integer) data[0], data[1].toString(), data[2].toString(), data[3].toString(), (float) data[4]);
  }
  ...
  public void addStudent(Student c){
      this.objects.add(c);
      Doc newDoc = new Doc(c.toHtmlDoc());
      this.engine.addDoc(newDoc);
  }
  ...
  public Query search(String[] words) throws NotPossibleException{
    ...
    Query q = this.engine.queryFirst(words[0]);
